...
export const mockAccounts: Account[] = [
  // ASSETS (1000-1999)
  { id: '1000', code: '1000', name: 'Cash - Operating', type: 'Asset', balance: 158432, description: 'Primary operating cash account' },
  { id: '1010', code: '1010', name: 'Cash - Vault (Cannabis)', type: 'Asset', balance: 45200, cannabisRelated: true, icon: '🌿', description: 'Secure cash vault for cannabis operations' },
  { id: '1020', code: '1020', name: 'Bank - Checking', type: 'Asset', balance: 225840, description: 'Primary checking account' },
  { id: '1030', code: '1030', name: 'Bank - Savings', type: 'Asset', balance: 50000, description: 'Business savings account' },
  { id: '1200', code: '1200', name: 'Accounts Receivable', type: 'Asset', balance: 128450, description: 'Customer receivables' },
  { id: '1300', code: '1300', name: 'Inventory - Cannabis Flower', type: 'Asset', balance: 85600, cannabisRelated: true, icon: '🌿', description: 'Cannabis flower inventory' },
  { id: '1310', code: '1310', name: 'Inventory - Edibles', type: 'Asset', balance: 42300, cannabisRelated: true, icon: '🍬', description: 'Cannabis edibles inventory' },
  { id: '1320', code: '1320', name: 'Inventory - Concentrates', type: 'Asset', balance: 28900, cannabisRelated: true, icon: '💎', description: 'Cannabis concentrates inventory' },
  { id: '1500', code: '1500', name: 'Equipment - Cultivation', type: 'Asset', balance: 125000, description: 'Cultivation equipment' },
  { id: '1510', code: '1510', name: 'Equipment - Processing', type: 'Asset', balance: 85000, description: 'Processing equipment' },
  { id: '1600', code: '1600', name: 'Accumulated Depreciation', type: 'Asset', balance: -32000, description: 'Equipment depreciation' },
  
  // LIABILITIES (2000-2999)
  { id: '2000', code: '2000', name: 'Accounts Payable', type: 'Liability', balance: 45230, description: 'Vendor payables' },
  { id: '2100', code: '2100', name: 'Payroll Tax Liability', type: 'Liability', balance: 12340, description: 'Payroll tax obligations' },
  { id: '2110', code: '2110', name: 'Sales Tax Liability', type: 'Liability', balance: 18750, description: 'Sales tax obligations' },
  { id: '2120', code: '2120', name: 'Excise Tax Liability', type: 'Liability', balance: 15600, cannabisRelated: true, icon: '🌿', description: 'Cannabis excise tax' },
  { id: '2200', code: '2200', name: 'Credit Card Payable', type: 'Liability', balance: 8450, description: 'Credit card balances' },
  { id: '2300', code: '2300', name: 'Long-term Debt', type: 'Liability', balance: 68000, description: 'Business loans' },
  
  // EQUITY (3000-3999)
  { id: '3000', code: '3000', name: 'Common Stock', type: 'Equity', balance: 500000, description: 'Owner equity' },
  { id: '3100', code: '3100', name: 'Retained Earnings', type: 'Equity', balance: 150552, description: 'Accumulated profits' },
  { id: '3200', code: '3200', name: 'Owners Draw', type: 'Equity', balance: -25000, description: 'Owner distributions' },
  
  // REVENUE (4000-4999)
  { id: '4000', code: '4000', name: 'Cannabis Sales - Flower', type: 'Revenue', balance: 145230, cannabisRelated: true, icon: '🌿', description: 'Flower product sales' },
  { id: '4010', code: '4010', name: 'Cannabis Sales - Edibles', type: 'Revenue', balance: 68450, cannabisRelated: true, icon: '🍬', description: 'Edibles product sales' },
  { id: '4020', code: '4020', name: 'Cannabis Sales - Concentrates', type: 'Revenue', balance: 32210, cannabisRelated: true, icon: '💎', description: 'Concentrates product sales' },
  { id: '4100', code: '4100', name: 'Wholesale Revenue', type: 'Revenue', balance: 58900, cannabisRelated: true, description: 'B2B wholesale sales' },
  { id: '4200', code: '4200', name: 'Consulting Revenue', type: 'Revenue', balance: 12400, description: 'Consulting services' },
  
  // COGS (5000-5099) - 280E Deductible
  { id: '5000', code: '5000', name: 'COGS - Cannabis Product', type: 'COGS', balance: 45600, is280EDeductible: true, icon: '✅', description: 'Direct product costs' },
  { id: '5010', code: '5010', name: 'COGS - Cultivation Labor', type: 'COGS', balance: 22300, is280EDeductible: true, icon: '✅', description: 'Growing labor costs' },
  { id: '5020', code: '5020', name: 'COGS - Packaging', type: 'COGS', balance: 8900, is280EDeductible: true, icon: '✅', description: 'Product packaging' },
  { id: '5030', code: '5030', name: 'COGS - Testing & Compliance', type: 'COGS', balance: 6800, is280EDeductible: true, icon: '✅', description: 'Lab testing costs' },
  
  // EXPENSES (5100-5999) - 280E Non-Deductible
  { id: '5100', code: '5100', name: 'Payroll Expense - Budtenders', type: 'Expense', balance: 28450, is280EDeductible: false, icon: '❌', description: 'Retail staff wages' },
  { id: '5110', code: '5110', name: 'Payroll Expense - Management', type: 'Expense', balance: 18200, is280EDeductible: false, icon: '❌', description: 'Management salaries' },
  { id: '5120', code: '5120', name: 'Payroll Tax Expense', type: 'Expense', balance: 6240, is280EDeductible: false, icon: '❌', description: 'Employer payroll taxes' },
  { id: '5200', code: '5200', name: 'Rent Expense', type: 'Expense', balance: 15000, is280EDeductible: false, icon: '❌', description: 'Facility rent' },
  { id: '5210', code: '5210', name: 'Utilities', type: 'Expense', balance: 4500, is280EDeductible: false, icon: '❌', description: 'Electricity, water, gas' },
  { id: '5300', code: '5300', name: 'Marketing & Advertising', type: 'Expense', balance: 8900, is280EDeductible: false, icon: '❌', description: 'Marketing costs' },
  { id: '5310', code: '5310', name: 'Professional Fees', type: 'Expense', balance: 12400, is280EDeductible: false, icon: '❌', description: 'Legal, accounting fees' },
  { id: '5400', code: '5400', name: 'Insurance', type: 'Expense', balance: 6800, is280EDeductible: false, icon: '❌', description: 'Business insurance' },
  { id: '5410', code: '5410', name: 'Office Supplies', type: 'Expense', balance: 1240, is280EDeductible: false, icon: '❌', description: 'Office materials' },
  { id: '5500', code: '5500', name: 'Depreciation Expense', type: 'Expense', balance: 2800, is280EDeductible: false, icon: '❌', description: 'Equipment depreciation' },
  { id: '5600', code: '5600', name: 'Interest Expense', type: 'Expense', balance: 1200, is280EDeductible: false, icon: '❌', description: 'Loan interest' },
];
