...
JERP™ is a trademark of Julio Cesar Mendez Tobar. Unauthorized use is prohibited.

## Third-Party Components

This software uses the following open-source components under their respective licenses:

### .NET Libraries (MIT License)
- ASP.NET Core 8.0
...
- PostgreSQL Client (PostgreSQL License)
- Stripe SDK (Apache 2.0)

Full list of third-party licenses available in THIRD-PARTY-NOTICES.md
